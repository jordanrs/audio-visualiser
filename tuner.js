...
(function() {
  (function() {
    var frequencyData, gradient, loadCanvas, loadFileIntoAudio, localFileLoad, processStream, soundAnalyser, timeData, updateGraph;
    window.audioMixer = {};
    soundAnalyser = [];
    ...
    updateGraph = function() {
      var data, i, imageData, point, _i, _j, _len, _len1;
      ...
      for (i = _j = 0, _len1 = timeData.length; _j < _len1; i = ++_j) {
        data = timeData[i];
